package rip.kuda.xenon.bukkit.command;
...
@CommandAlias("rank")
@CommandPermission("xenon.cmd.rank")
public class RankCommands extends BaseCommand {
    ...
    @CommandPermission("xenon.rank.create")
    ...
    @CommandPermission("xenon.rank.delete")
    ...
    @CommandPermission("xenon.rank.color")
    ...
    @CommandPermission("xenon.rank.prefix")
    @CommandCompletion("@ranks")
    @Syntax("<rank> [prefix]")
    ...
    @CommandPermission("xenon.rank.suffix")
    @CommandCompletion("@ranks")
    @Syntax("<rank> [suffix]")
    ...
    @CommandPermission("xenon.rank.staff")
    @CommandCompletion("@ranks")
    @Syntax("<rank>")
    ...
    @CommandPermission("xenon.rank.hidden")
    @CommandCompletion("@ranks")
    @Syntax("<rank>")
    ...
    @CommandPermission("xenon.rank.purchasable")
    @CommandCompletion("@ranks")
    @Syntax("<rank>")
    ...
    @CommandPermission("xenon.rank.default")
    @CommandCompletion("@ranks")
    @Syntax("<rank>")
    ...
    @CommandPermission("xenon.rank.weight")
    @CommandCompletion("@ranks @nothing")
    @Syntax("<rank> <weight>")
    ...
    @CommandPermission("xenon.rank.permission")
    @CommandCompletion("@ranks @nothing")
    ...
    @CommandPermission("xenon.rank.info")
    @CommandCompletion("@ranks")
    @Syntax("<rank>")
    ...
    @CommandPermission("xenon.rank.list")
